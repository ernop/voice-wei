...
(async () => {
...

    {
        ...
        report.check('books AI Research instructions require plain spoken-ready prose under Orwell\'s six rules',
            aiQuestion.instructions.includes('shown on screen and read aloud exactly as written')
            && aiQuestion.instructions.includes('ordinary, literal English')
            && aiQuestion.instructions.includes('Do not use markdown, headings, bullet characters')
            && aiQuestion.instructions.includes('Never put a raw URL in the answer text')
            && aiQuestion.instructions.includes('Do not repeat the reader\'s question, the book title, the author, or the chapter name')
            && aiQuestion.instructions.includes('let the citation carry the attribution')
            && aiQuestion.instructions.includes('Write the answer under George Orwell\'s six rules, reproduced here verbatim:')
            && aiQuestion.instructions.includes(booksOrwellSixRules));
